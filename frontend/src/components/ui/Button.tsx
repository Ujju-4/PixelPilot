...
const VARIANT_CLASSES: Record<Variant, string> = {
  primary:
    'bg-accent hover:bg-accent-hover text-white border-transparent shadow-sm hover:shadow',
  secondary:
    'bg-surface dark:bg-surface-dark hover:bg-canvas dark:hover:bg-canvas-dark text-ink dark:text-ink-dark border-border/50 dark:border-border-dark/50 hover:border-border dark:hover:border-border-dark',
  ghost:

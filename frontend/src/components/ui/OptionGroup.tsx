          ...
          <button
            ...
            className={[
              ...
              value === option.value
                ...
                : 'border-border/60 dark:border-border-dark/50 text-ink-secondary hover:text-ink dark:text-ink-dark-secondary dark:hover:text-ink-dark hover:border-border dark:hover:border-border-dark bg-transparent',
            ].join(' ')}
          >
            {option.label}
          </button>
